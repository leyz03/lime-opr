...
| Cell | Bound | μ | gap% | vs_EF% | Time(s) |
|---|---|---|---|---|---|
| int+CCD | -174.4 | -1082.4 | 83.9% | 83.9% | 8.1 |
...
| Cell | Bound | μ | gap% | vs_EF% | Time(s) |
|---|---|---|---|---|---|
| int+CCD | -95.3 | -1157.6 | 91.8% | 91.7% | 2.8 |
...
| Cell | Bound | μ | gap% | vs_EF% | Time(s) |
|---|---|---|---|---|---|
| int+CCD | -123.8 | -1221.8 | 89.9% | 89.9% | 3.3 |
...
> 这表明 SDDiP 的 cut 作为上界估计工具还有改进空间，但作为策略生成工具已经有效。
